...
<!-- App_Store -->
<section class="app_store  m-t-40" >
  <div class="container"> 
    <!-- Row  -->
    <div class="row justify-content-center">
      <div class="col-md-10 text-center">
        ...
        <h6 class="subtitle">Ultimate social media app and earning app designed to empower individuals to connect, share, and thrive in a digital world.</h6>
      </div>
    </div>
    <!-- Row  -->
    <div class="row">
      <div class="app_parts ">
        ...
        <button class="app-btn btn" type="submit" value="butten"><i class="fa fa-windows app-icon"></i> Microsoft Store </button>
      </div>
    </div>
  </div>
</section>
