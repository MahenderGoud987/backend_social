...
<!-- popup -->
  ...
  <label class="control-label" for="competition-position">Select winner competition position</label>
   ...
   echo Html::dropDownList("competition_position_id",'competition_id', $competitionPositionData,['class'=>'form-control','prompt' => 'Select Competition Position','onchange'=>'
    var id =  $(this).val();
...
$('.card').click(function(){
  ...
  $("#winner_post_id"+id).val(userid);

  // $(".winner_post_id").attr("name","winner_post_id"+id);
