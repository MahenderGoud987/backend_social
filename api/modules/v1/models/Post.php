...
class Post extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id','type','post_content_type','competition_id','club_id','status','user_id','total_view','total_like','total_share','total_comment','is_share_post','share_level','origin_post_id','audio_id','audio_start_time','audio_end_time','is_add_to_post', 'created_at','created_by', 'updated_by','poll_id','is_comment_enable'], 'integer'],
    ...
    {
        return ['user','clubDetail','audio','giftSummary','promotionPost','postPromotionData','isPostView','isFavorite','originPost','pollDetails'];
    }
