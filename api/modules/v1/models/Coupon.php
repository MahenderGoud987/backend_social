...
class Coupon extends \yii\db\ActiveRecord
{
    ...
    public function getImageUrl()
    {
        if($this->image){
            ...
            return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_COUPON,$this->image);
    ...
    public function updateCommentCounter($postId){
        ...
        $model = new Comment();
        $totalCount = $model->find()->where(['reference_id'=>$postId,'status'=>$model::STATUS_ACTIVE ,'type'=>$model::TYPE_COUPON])->count();
