...
class Payment extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id','type','coin','user_id','package_id','transaction_type','payment_type','payment_mode','live_tv_id','gift_history_id','event_ticket_booking_id','created_at','dating_subscription_id','campaign_id','ad_package_id','ad_id'], 'integer'],
            [['amount'], 'number'],
