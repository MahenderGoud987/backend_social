...
class PostSearch extends Post
{
    ...
    public function rules()
    {
        return [
            ...
            [['user_id', 'club_id', 'audio_id', 'is_popular_post', 'is_following_user_post', 'is_my_post', 'is_winning_post', 'is_recent', 'is_reel','minimum_follower_user','is_favorite','is_video_post'], 'integer'],
            //  [['title'], 'safe'],
        ];
    }
