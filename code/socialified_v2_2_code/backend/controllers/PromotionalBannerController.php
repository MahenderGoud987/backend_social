    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if($model->imageFile){
                    ...
                    $imagePath 			=	Yii::$app->params['pathUploadPromotionalBanner'] ."/".$model->image;
                    $imagePathThumb 	=	Yii::$app->params['pathUploadPromotionalBannerThumb'] ."/".$model->image;
                    $model->imageFile->saveAs($imagePath,false);


                    Image::thumbnail($imagePath, 370, 233)
