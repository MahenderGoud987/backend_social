...
class Campaign extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'cover_image'], 'string', 'max' => 100],
             ...
             [['exampleFile','imageFile','category_id'], 'required','on'=>'create'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'target_value' => Yii::t('app', 'Target Value (optional)'),
            'raised_value' => Yii::t('app', 'Raised Value (optional)'),
    ...
    public function getImageUrl()
    {
        ...
        return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_CAMPAGIN,$this->cover_image);
